...
type Curry<P, R> = P extends [infer First, ...infer Rest] ? (p: First) => Curry<Rest, R> : R

declare function Currying<Fn>(fn: Fn): Fn extends (...args: infer P) => infer R ? Curry<P, R> : never
